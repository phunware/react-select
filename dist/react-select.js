	...
	createClass(CreatableSelect, [{
			...
			if (isValidNewOption({ label: this.inputValue })) {
				...
				if (_isOptionUnique) {
					if (onNewOptionClick) {
						...
						this.setState({ newOptions: [option].concat(toConsumableArray(this.state.newOptions)) });
		...
		value: function render() {
			...
			var _props4 = this.props,
			    ...
			    propOptions = _props4$options === undefined ? [] : _props4$options,
			    refProp = _props4.ref,
			    restProps = objectWithoutProperties(_props4, ['newOptionCreator', 'shouldKeyDownEventCreateNewOption', 'options', 'ref']);
			...
			var options = [].concat(toConsumableArray(this.state.newOptions), toConsumableArray(propOptions));
